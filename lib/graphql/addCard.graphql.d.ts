/* 7198e6e78a970954e41f2a2aca2f3e29aa9d241a
...
export declare type AddCardMutationVariables = Exact<{
    input: AddCardInput;
}>;
export declare type AddCardMutation = ({
    __typename?: 'Mutation';
} & {
    addCard: ({
        __typename?: 'Card';
...
export declare const AddCardDocument: Apollo.DocumentNode;
export declare type AddCardMutationFn = Apollo.MutationFunction<AddCardMutation, AddCardMutationVariables>;
export declare function useAddCardMutation(baseOptions?: Apollo.MutationHookOptions<AddCardMutation, AddCardMutationVariables>): Apollo.MutationTuple<AddCardMutation, Exact<{
    input: AddCardInput;
}>>;
export declare type AddCardMutationHookResult = ReturnType<typeof useAddCardMutation>;
export declare type AddCardMutationResult = Apollo.MutationResult<AddCardMutation>;
export declare type AddCardMutationOptions = Apollo.BaseMutationOptions<AddCardMutation, AddCardMutationVariables>;
