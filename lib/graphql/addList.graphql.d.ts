/* 595183728c3c46e9917e404303fd92218c44ca70
...
export declare type AddListMutationVariables = Exact<{
    input: AddListInput;
}>;
export declare type AddListMutation = ({
    __typename?: 'Mutation';
} & {
    addList: ({
        __typename?: 'List';
...
export declare const AddListDocument: Apollo.DocumentNode;
export declare type AddListMutationFn = Apollo.MutationFunction<AddListMutation, AddListMutationVariables>;
export declare function useAddListMutation(baseOptions?: Apollo.MutationHookOptions<AddListMutation, AddListMutationVariables>): Apollo.MutationTuple<AddListMutation, Exact<{
    input: AddListInput;
}>>;
export declare type AddListMutationHookResult = ReturnType<typeof useAddListMutation>;
export declare type AddListMutationResult = Apollo.MutationResult<AddListMutation>;
export declare type AddListMutationOptions = Apollo.BaseMutationOptions<AddListMutation, AddListMutationVariables>;
