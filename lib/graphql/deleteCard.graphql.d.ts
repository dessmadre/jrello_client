/* d9cff7da779dc3adebe400ca1dd957cdb4646740
...
export declare type DeleteCardMutationVariables = Exact<{
    id: Scalars['ObjectId'];
}>;
export declare type DeleteCardMutation = ({
    __typename?: 'Mutation';
} & Pick<Mutation, 'deleteCard'>);
export declare const DeleteCardDocument: Apollo.DocumentNode;
export declare type DeleteCardMutationFn = Apollo.MutationFunction<DeleteCardMutation, DeleteCardMutationVariables>;
export declare function useDeleteCardMutation(baseOptions?: Apollo.MutationHookOptions<DeleteCardMutation, DeleteCardMutationVariables>): Apollo.MutationTuple<DeleteCardMutation, Exact<{
    id: any;
}>>;
export declare type DeleteCardMutationHookResult = ReturnType<typeof useDeleteCardMutation>;
export declare type DeleteCardMutationResult = Apollo.MutationResult<DeleteCardMutation>;
export declare type DeleteCardMutationOptions = Apollo.BaseMutationOptions<DeleteCardMutation, DeleteCardMutationVariables>;
