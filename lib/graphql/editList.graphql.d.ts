/* b8fdfbd699653231e433dc7e59d9c7752911c36d
...
export declare type EditListMutationVariables = Exact<{
    input: EditListInput;
}>;
export declare type EditListMutation = ({
    __typename?: 'Mutation';
} & {
    editList: ({
        __typename?: 'List';
...
export declare const EditListDocument: Apollo.DocumentNode;
export declare type EditListMutationFn = Apollo.MutationFunction<EditListMutation, EditListMutationVariables>;
export declare function useEditListMutation(baseOptions?: Apollo.MutationHookOptions<EditListMutation, EditListMutationVariables>): Apollo.MutationTuple<EditListMutation, Exact<{
    input: EditListInput;
}>>;
export declare type EditListMutationHookResult = ReturnType<typeof useEditListMutation>;
export declare type EditListMutationResult = Apollo.MutationResult<EditListMutation>;
export declare type EditListMutationOptions = Apollo.BaseMutationOptions<EditListMutation, EditListMutationVariables>;
