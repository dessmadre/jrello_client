/* e7617e4c969b2fc57228706b60f6497959b36cad
...
export declare type DeleteListMutationVariables = Exact<{
    id: Scalars['ObjectId'];
}>;
export declare type DeleteListMutation = ({
    __typename?: 'Mutation';
} & Pick<Mutation, 'deleteList'>);
export declare const DeleteListDocument: Apollo.DocumentNode;
export declare type DeleteListMutationFn = Apollo.MutationFunction<DeleteListMutation, DeleteListMutationVariables>;
export declare function useDeleteListMutation(baseOptions?: Apollo.MutationHookOptions<DeleteListMutation, DeleteListMutationVariables>): Apollo.MutationTuple<DeleteListMutation, Exact<{
    id: any;
}>>;
export declare type DeleteListMutationHookResult = ReturnType<typeof useDeleteListMutation>;
export declare type DeleteListMutationResult = Apollo.MutationResult<DeleteListMutation>;
export declare type DeleteListMutationOptions = Apollo.BaseMutationOptions<DeleteListMutation, DeleteListMutationVariables>;
