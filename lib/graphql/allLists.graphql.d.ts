/* 794a80cd52678bd6d5cfce46350a0c1a818e03c4
...
export declare type AllListsQueryVariables = Exact<{
    id: Scalars['ObjectId'];
}>;
export declare type AllListsQuery = ({
    __typename?: 'Query';
} & {
    allLists: Array<({
        __typename?: 'List';
...
export declare const AllListsDocument: Apollo.DocumentNode;
export declare function useAllListsQuery(baseOptions: Apollo.QueryHookOptions<AllListsQuery, AllListsQueryVariables>): Apollo.QueryResult<AllListsQuery, Exact<{
    id: any;
}>>;
export declare function useAllListsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AllListsQuery, AllListsQueryVariables>): Apollo.QueryTuple<AllListsQuery, Exact<{
    id: any;
}>>;
export declare type AllListsQueryHookResult = ReturnType<typeof useAllListsQuery>;
export declare type AllListsLazyQueryHookResult = ReturnType<typeof useAllListsLazyQuery>;
export declare type AllListsQueryResult = Apollo.QueryResult<AllListsQuery, AllListsQueryVariables>;
