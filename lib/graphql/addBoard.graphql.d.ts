/* c854055614fcdc4187126290053f89442df39c9f
...
export declare type AddBoardMutationVariables = Exact<{
    input: AddBoardInput;
}>;
export declare type AddBoardMutation = ({
    __typename?: 'Mutation';
} & {
    addBoard: ({
        __typename?: 'Board';
...
export declare const AddBoardDocument: Apollo.DocumentNode;
export declare type AddBoardMutationFn = Apollo.MutationFunction<AddBoardMutation, AddBoardMutationVariables>;
export declare function useAddBoardMutation(baseOptions?: Apollo.MutationHookOptions<AddBoardMutation, AddBoardMutationVariables>): Apollo.MutationTuple<AddBoardMutation, Exact<{
    input: AddBoardInput;
}>>;
export declare type AddBoardMutationHookResult = ReturnType<typeof useAddBoardMutation>;
export declare type AddBoardMutationResult = Apollo.MutationResult<AddBoardMutation>;
export declare type AddBoardMutationOptions = Apollo.BaseMutationOptions<AddBoardMutation, AddBoardMutationVariables>;
