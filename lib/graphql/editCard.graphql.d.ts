/* f30164d76e3008f146bb9d920eabc537dc818a35
...
export declare type EditCardMutationVariables = Exact<{
    input: EditCardInput;
}>;
export declare type EditCardMutation = ({
    __typename?: 'Mutation';
} & {
    editCard: ({
        __typename?: 'Card';
...
export declare const EditCardDocument: Apollo.DocumentNode;
export declare type EditCardMutationFn = Apollo.MutationFunction<EditCardMutation, EditCardMutationVariables>;
export declare function useEditCardMutation(baseOptions?: Apollo.MutationHookOptions<EditCardMutation, EditCardMutationVariables>): Apollo.MutationTuple<EditCardMutation, Exact<{
    input: EditCardInput;
}>>;
export declare type EditCardMutationHookResult = ReturnType<typeof useEditCardMutation>;
export declare type EditCardMutationResult = Apollo.MutationResult<EditCardMutation>;
export declare type EditCardMutationOptions = Apollo.BaseMutationOptions<EditCardMutation, EditCardMutationVariables>;
